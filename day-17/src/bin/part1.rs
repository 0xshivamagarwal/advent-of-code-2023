...
fn solve(matrix: &Vec<Vec<usize>>) -> usize {
    ...
    let mut queue = BinaryHeap::from([
        Tuple::new(0, 0, Direction::UP, 1, 0),
        Tuple::new(0, 0, Direction::LEFT, 1, 0),
    ]);
    ...
    while !queue.is_empty() {
        ...
        if h > min_heat_lost || c > 3 || x >= n || y >= m {
            continue;
        }
...
4322674655533"
    ...
    #[test]
    fn it_works_2() {
        assert_eq!(process(include_str!("../../input.txt")), 861);
    }
}
